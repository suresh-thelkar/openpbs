...
load_sched(PGresult *res, pbs_db_sched_info_t *psch, int row)
{
	...
	GET_PARAM_STR(res, 0, psch->sched_name, sched_name_fnum);
	GET_PARAM_STR(res, 0, psch->sched_sv_name, sched_sv_name_fnum);
	GET_PARAM_BIGINT(res, 0, psch->sched_savetm, sched_savetm_fnum);
	GET_PARAM_BIGINT(res, 0, psch->sched_creattm, sched_creattm_fnum);
