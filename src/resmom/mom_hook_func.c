	 ...
	 mom_process_hooks_params_t *php)
{
	...
	if (php)
		...
		strncpy(hook_config_path, ((struct python_script *) phook->script)->path, sizeof(hook_config_path) - 1);
		...
		if (runas_jobuser) {
			...
			strncpy(script_path, ((struct python_script *) phook->script)->path, sizeof(script_path) - 1);
