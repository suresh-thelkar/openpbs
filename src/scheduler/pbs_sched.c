...
/**
 * @brief connect to all the servers configured. Also add secondary connections of individual
 *              servers secondary sd's to the poll list
 *
 *
 * @return void
 */
...
/**
 * @brief Initialises event poll context for all the servers and also commands queue
 *
 * @return void
 */
static void
